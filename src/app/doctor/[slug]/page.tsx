  ...
  return (
    <div>
      ...
      <section className="doctor">
        <div className="md:max-w-[85%] m-auto pt-[3rem] p-4 pb-[6rem] ">
          <header className="bg-white/10 backdrop-blur-md border border-white/30 w-[95%] lg:w-[50%] m-auto left-[11px] lg:left-[24%] flex gap-1 md:gap-[1rem] md:items-center shadow-lg absolute top-[150px] md:top-[100px] py-3 px-[1rem] text-white rounded-xl">
            ...
            <div className="doc-stat flex flex-col gap-[1rem]">
              ...
              <div className="rating flex justify-center self-center ">
          ...
          {doctor?.paid && (
            <div className="md:pt-[12vh] pt-[1vh] flex justify-center">
              <iframe
          ...
          <div className="info gap-8 justify-between md:mt-[2rem] md:w-[80%] m-auto">
            <h1
              className={`text-[#449DD1] font-bold text-[20px] md:text-[30px] ${
                doctor?.paid ? "" : "md:pt-20"
              }`}
            >
            ...
            <div className="inguinal md:flex flex-row-reverse gap-4">
              ...
              <div className="text md:w-[50%]">
                ...
                <p className="font-[500] text-[#000000a4]">
                  ...
                  males. About 1 in 4 males will have an inguinal hernia at some
                  point in their lifetime. The testicle descending from the
                  abdomen into the scrotum predisposes males to have a natural
                  weakness in the groin where inguinal hernias occur.
                </p>
              </div>
            </div>
      ...
      <section className="reviews">
        <div className="md:max-w-[85%] m-auto p-4 py-[2rem]">
          <Swiper
            className="px-[2rem]"
            modules={[Pagination, A11y, Autoplay]} // ← Include Autoplay here
            spaceBetween={20}
            loop={true}
            pagination={{ clickable: true }}
            autoplay={{
              delay: 5000, // auto-slide every 5 seconds
              disableOnInteraction: false, // keeps autoplay even if user clicks
            }}
            breakpoints={{
              0: {
          ...
          >
            {doctor?.reviews.map((review, index) => (
              <SwiperSlide
                className="p-3 md:p-[4rem] shadow-lg rounded-xl my-[3rem] flex flex-col justify-between min-h-[300px]"
                key={index}
              >
                <div className="rating flex items-center text-[18px] mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Icon
                      key={i}
                      icon="material-symbols:star"
                ...
                <div className="review text-[14px] md:text-[18px] flex flex-col flex-grow">
